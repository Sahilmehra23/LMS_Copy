                        ...
                        <TableBody>
                            {tasks.results.map((task, index) => (
                                <StyledTableRow key={task.id}>
                                    ...
                                    <StyledTableCell align="center">
                                        {getValueOption(task.type=='internal_support'? taskInternalSupportOptions:taskStudentSupportOptions, task.student_support_type)}
                                    </StyledTableCell>
                                    ...
                                    <StyledTableCell align="center">
                                        {getDateFormat(task.created_at)}
                                    </StyledTableCell>
                                    <StyledTableCell align="center">{task.updated_by && task.updated_by.name}</StyledTableCell>
                                                ...
                                                <CustomButton
                                                    onClick={() =>
                                                        taskRequest.checkCommunication(task.id).then((res) => {
                                                            history.push(`/communication/score/${res.task_communication.id}`, {
